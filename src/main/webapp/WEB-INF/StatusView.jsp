            ...
            <div class="table-wrapper">
                ...
                <table id="dt-select" class="table table-striped table-hover" style="width: 100%">
                    ...
                    <c:forEach var="sts" items="${status}">
                        <td class="col1">${sts.id}</td>
                        <td class="col2">${sts.name}</td>
                        <td>
                            <a href="#showModal" class="confirm"  data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                            <a href="" class="delete" data-toggle="modal" onclick="dlt('${sts.id}')" ><i class="material-icons" data-toggle="tooltip" title="Delete" >&#xE872;</i></a>
                        </td>
                        </tr>
                    </c:forEach>
                    </tbody>
