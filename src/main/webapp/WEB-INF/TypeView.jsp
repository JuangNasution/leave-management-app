...
<html xmlns:th="http://www.thymeleaf.org"> 
        ...
        <div class="container">
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        <div class="col-sm-6">
                            <h2>Manage <b>Type</b></h2>
                        </div>
                        <div class="col-sm-6">
                            <a href="#showModal" class="btn btn-success btnInsert" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add New Type</span></a>						
                        </div>
                    </div>
                </div>
                <table id="dt-select" class="table table-striped table-hover" style="width: 100%">
                    ...
                    <c:forEach var="type" items="${types}">
                        <td class="col1">${type.id}</td>
                        <td class="col2">${type.name}</td>
                        <td class="col3">${type.amount}</td>
                        <td class="col4">${type.category.name}</td>
                        <td>
                            <a href="#showModal" class="confirm"  data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                            <a href="" class="delete" data-toggle="modal" onclick="dlt('${type.id}')" ><i class="material-icons" data-toggle="tooltip" title="Delete" >&#xE872;</i></a>
                        </td>
                        </tr>
                    </c:forEach>
                    </tbody>
    ...
    <script>
        $(".confirm").click(function () {
            ...
            $('h4.modal-title').text('Update Type');
            $("#id").attr('readonly', true);
        });
        $(".btnInsert").click(function () {
            document.getElementById("id").value = "";
            document.getElementById("name").value = "";
            $('h4.modal-title').text('Insert Type');
